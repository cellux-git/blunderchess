...
impl Eval {
    pub(crate) fn eval_rooks(&self, board: &Board, pawns_bb: u64, enemy_pawns_bb: u64, color: Color, mg: &mut i32, eg: &mut i32) {
    ...
    pub(crate) fn eval_bad_bishops(&self, board: &Board, color: Color, pawns_bb: u64, mg: &mut i32, eg: &mut i32) {
        let my_bishops = board.pieces_bb(Piece::Bishop) & board.colors_bb(color);
        if my_bishops == 0 { return; }
    ...
    pub(crate) fn eval_knights(&self, board: &Board, color: Color, enemy_pawns_bb: u64, mg: &mut i32, eg: &mut i32) {
    ...
    pub(crate) fn eval_rook_queen_battery(&self, board: &Board, color: Color, mg: &mut i32, eg: &mut i32) {
        let us_bb = board.colors_bb(color);
    ...
    pub(crate) fn eval_queen_multiattack(&self, board: &Board, color: Color, enemy: Color, mg: &mut i32, eg: &mut i32) {
        let us_bb = board.colors_bb(color);
    ...
    pub(crate) fn eval_exchange(&self, board: &Board, color: Color, pawns_bb: u64, mg: &mut i32, eg: &mut i32) {
        let us_bb = board.colors_bb(color);
        ...
        if rook_diff != 1 || minor_diff != -1 { return; }
    ...
    pub(crate) fn eval_space(&self, _board: &Board, color: Color, pawns_bb: u64, _enemy_pawns_bb: u64, mg: &mut i32, eg: &mut i32) {
    ...
    pub(crate) fn eval_pawn_majority(&self, pawns_bb: u64, enemy_pawns_bb: u64, _color: Color, mg: &mut i32, eg: &mut i32) {
